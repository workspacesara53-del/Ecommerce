            ...
            >
                ...
                <div className="px-8 pb-10 pt-6">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-black text-gray-900 mb-2">Join us today!</h1>
                        <p className="text-gray-500 font-medium px-4">Get special benefits and stay up-to-date.</p>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="relative py-2">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase">
                                <span className="bg-white px-4 text-gray-400 font-bold tracking-widest">Or sign up with email</span>
                            </div>
                        </div>
                        ...
                        <div className="text-center pt-4">
                            <p className="text-sm text-gray-500 font-medium">
                                ...
                                <Link href="/login" className="text-primary font-black hover:underline ml-1 uppercase">
                                    Login
                                </Link>
                            </p>
                        </div>
